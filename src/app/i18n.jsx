...
const dict = {
  uz: {
    ...
    chats: {
      ...
      noChatsDescription: "Haydovchilar yoki yo'lovchilar bilan muloqotni boshlang",
    },
    booking: {
    ...
    auth: {
      ...
      passwordLabel: "Parol",
      phoneValidationError: "Telefon raqami 9 raqamdan iborat bo'lishi kerak",
  ...
  ru: {
    ...
    chats: {
      ...
      noChatsDescription: "Начните общение с водителями или пассажирами",
    },
    booking: {
    ...
    auth: {
      ...
      phoneValidationError: "Номер телефона должен содержать 9 цифр",
    ...
    orders: {
      ...
      bottomSheet: {
        ...
        carModelLabel: "Модель",
        carNumberLabel: "Номер",
        carColorLabel: "Цвет",
        priceLabel: "Цена:"
      },
      offerForm: {
